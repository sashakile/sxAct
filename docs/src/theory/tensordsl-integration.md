...
## 5. Synergy with xAct.jl
Within this repository, the existing `xAct.jl` framework becomes a **user** of the `tensordsl` parser.
...
├── docs/src/theory/tensordsl-integration.md
