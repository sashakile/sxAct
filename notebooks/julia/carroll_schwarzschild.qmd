---
title: "Carroll: Schwarzschild Geodesics and Curvature"
jupyter: julia-1.12
---
...
## 4. Curvature and Vacuum Equations
...
# In a real session, we would use the abstract engine to show
# that Ric[-a,-b] simplifies to 0 given the Schwarzschild constraints.
# For this tutorial, we verify the components.
println("Ricci tensor components (expecting zeros):")
# (Evaluation logic here would call the engine)
```
