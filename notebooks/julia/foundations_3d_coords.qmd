...
- **Curvature**: Explore intrinsic curvature in [The 2-Sphere](foundations_sphere.qmd).
- **Basics**: Review 2D transformations in [Polar vs. Cartesian](foundations_2d_polar.qmd).
