> [!CAUTION]
> **ARCHIVED RFC**: This foundational RFC has been moved to the [elegua](https://github.com/sashakile/elegua) and [chacana](https://github.com/sashakile/chacana) repositories.
> **DO NOT EDIT THIS FILE.** All future architectural work must follow the split repository structure.
